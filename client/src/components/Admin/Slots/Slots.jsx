    ...
    <div>
      ...
      {/* {
        sloatBooking.map((items)=>{
            return(
     <div className={`w-28 h-28 cursor-pointer bg-blue-400 hover:bg-blue-900  ${items.status ? "bg-blue-300" : "bg-blue-900"}`} onClick={() => items.status ? alert("This sloat is Already Booked"): fullDetails(items.sloatNo)}>{items.sloatNo}</div>
