  ...
  return (
       ...
       <div className='p-10'>
        ...
        <div className='flex justify-center  '>
            ...
            <h1 className='text-blue-400 font-bold text-2xl  '>Application Form </h1>
          <form className='m-20 border-t-2 border-blue-300'  >
                        ...
                        <div className='px-5 w-fit mx-auto pb-5'>
                            <button onClick={(e)=> handleSubmit(e)} className='border-2 text-blue-800 border-blue-200 rounded-full px-12 py-2 inline-block font-semibold hover:bg-blue-400 hover:text-blue'>Submit</button>
                        </div>
